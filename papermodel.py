...
run_names = ['x_reg', 'y_reg', 'unum_class']
...
def read_file():
    ...
    #file_name = '1000matches_kicker.csv'
    file_name = '1000matches_kicker_shoot.csv'
    #file_name = '1000matches_kicker_pass.csv'
...
if use_classification:
    ...
    model_checkpoint_callback = callbacks.ModelCheckpoint(
        ...
        mode='max',
        save_best_only=True)
    history = network.fit(train_datas, train_labels, epochs=50, callbacks=[model_checkpoint_callback], batch_size=64,
    ...
    if new_training:
        ...
        print("CONTINUED TRAINING RESULTS:")
    ...
    network.compile(optimizer=optimizers.Adam(learning_rate=0.001), loss='mean_absolute_error', metrics=['mean_absolute_error'])
